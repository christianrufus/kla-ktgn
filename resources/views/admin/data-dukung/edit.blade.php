            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form id="editForm" class="space-y-4" onsubmit="return handleSubmit(event)">
                        ...
                        <!-- File Upload Section -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">Upload File Baru</label>
                            <div class="space-y-4">
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Upload</label>
                                    <input type="file" name="files[]" id="fileInput" multiple class="mt-1 block w-full"
                                    ...
                                    <div id="file-row-{{ $file->id }}"
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-medium text-gray-700">{{ $file->original_name }}</span>
                                                <span
                                                    class="text-xs text-gray-500">{{ $fileSize > 0 ? number_format($fileSize / 1024, 2) . ' KB' : 'Ukuran tidak tersedia' }}</span>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <a href="{{ url('storage/' . $file->file) }}" target="_blank"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $dataDukung->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center justify-end">
                            <a href="{{ route('admin.data-dukung.index') }}"
        ...
        <script>
            ...
            function updateFilePreview() {
                ...
                Array.from(input.files).forEach((file, index) => {
                    ...
                    fileName.className = 'flex-1 text-sm';
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Soft delete: sembunyikan file dari UI, tampung ID-nya
                window.deleteFile = function (id) {
                    ...
                    const container = document.getElementById('filesToDelete');
                    ...
                    if (selectedKlasterId) {
                        axios.get(`/api/klaster/${selectedKlasterId}/indikators`)
                            .then(response => {
                                ...
                                response.data.forEach(indikator => {
                            ...
                            .catch(() => {
                                Swal.fire({ icon: 'error', title: 'Gagal', text: 'Gagal memuat data indikator' });
                            });
                    }
                }
