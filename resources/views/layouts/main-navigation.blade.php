<nav x-data="{ open: false }"
    ...
    <!-- 1. KONTAINER UTAMA: Full width tanpa max-w agar Logo & Mobile Button tetap di ujung layar -->
    <div class="w-full px-4 sm:px-6">
        <div class="flex justify-between items-center h-14">
            
            <!-- Bagian Logo (Sekarang nempel di ujung kiri layar Anda) -->
            ...
            <!-- Tombol Mobile (Tetap di pojok kanan saat dibuka di HP) -->
    ...
    <!-- 2. KONTAINER MENU DESKTOP: Mengunci posisi teks agar pas di batas aman (max-w-7xl) seperti keinginan Anda -->
    <div class="absolute inset-0 max-w-7xl mx-auto px-4 sm:px-6 hidden xl:flex items-center justify-end pointer-events-none">
        <div class="flex items-center space-x-4 pointer-events-auto h-14">
            <a href="/"
        ...
        <div class="pt-2 pb-3 space-y-1 bg-white border-b border-gray-200">
            ...
            <div x-data="{ subOpen: false }" class="relative">
                <button @click="subOpen = !subOpen"
                    class="w-full flex items-center justify-between px-4 py-2 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50">
                    <span>Profil</span>
                    <svg class="ml-2 h-5 w-5 transform transition-transform duration-200"
                        :class="{'rotate-180': subOpen}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
                ...
                <div x-show="subOpen" class="px-4 py-2 bg-gray-50">
                    <a href="{{ route('profil.visi-misi') }}"
                        class="block px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Visi dan Misi</a>
                    <a href="{{ route('profil.program') }}"
                        class="block px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Program Kerja</a>
                </div>
            </div>
            ...
            <x-responsive-nav-link href="{{ route('data-dukung') }}" :active="request()->routeIs('data-dukung')">
                Data Dukung
            </x-responsive-nav-link>
            ...
            <div x-data="{ subOpen: false }" class="relative">
                ...
                <div x-show="subOpen" class="px-4 py-2 bg-gray-50">
                    <a href="{{ route('pemenuhan-hak-anak.klaster1') }}"
                        class="block px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Klaster 1</a>
                    <a href="{{ route('pemenuhan-hak-anak.klaster2') }}"
                        class="block px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Klaster 2</a>
                    <a href="{{ route('pemenuhan-hak-anak.klaster3') }}"
                        class="block px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Klaster 3</a>
                    <a href="{{ route('pemenuhan-hak-anak.klaster4') }}"
                        class="block px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Klaster 4</a>
                </div>
            </div>
            ...
            <div x-data="{ subOpen: false }" class="relative">
                ...
                <div x-show="subOpen" class="px-4 py-2 bg-gray-50">
                    <a href="{{ route('perlindungan-khusus-anak.klaster5') }}"
                        class="block px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Klaster 5</a>
                </div>
            </div>
