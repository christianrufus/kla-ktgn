<x-main-layout>
    <div class="relative h-[200px] md:h-[300px] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center px-4">
            ...
            <div class="flex items-center justify-center text-white text-base md:text-lg font-medium">
                ...
                <span class="text-yellow-300">Data Dukung</span>
            </div>
        </div>
    </div>
                    ...
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
                        ...
                        <div class="flex items-center gap-2 md:gap-3">
                            ...
                            <input type="search" 
                                   ...
                                   value="{{ request('q') }}"
                                   placeholder="Cari Data Dukung...">
                        </div>
                    </div>

                    <div id="dataDukungList" class="overflow-x-auto">
                        @include('beranda.data-dukung-list')
                    </div>
                </div>
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const dataDukungList = document.getElementById('dataDukungList');
        
        function updateContent(url = null) {
            const searchValue = searchInput.value;
            const perPage = entriesSelect.value;
            
            url = url || `{{ route('data-dukung') }}`;
            
            dataDukungList.classList.add('opacity-50');
            ...
            .then(html => {
                dataDukungList.innerHTML = html;
                dataDukungList.classList.remove('opacity-50');
        ...
        function applyLocalSearch() {
            ...
            const documentItems = dataDukungList.querySelectorAll('.flex.flex-col.sm\\:flex-row');
            let foundCount = 0;
        ...
        function updateResultCount(foundCount, totalCount) {
            const paginationInfo = dataDukungList.querySelector('.text-gray-600');
