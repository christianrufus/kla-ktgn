<x-main-layout>
        ...
        <div class="w-full">
            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="w-full lg:w-[320px] relative overflow-hidden lg:h-[500px]">
                    ...
                    <div
                        class="absolute inset-0 bg-gradient-to-b from-transparent via-black/30 to-black/70 lg:via-transparent lg:to-black/60">
                    </div>
                    <div
                        class="absolute inset-x-0 p-8 text-center h-full flex flex-col items-center justify-center lg:justify-start lg:top-[5%]">
                        <h2 class="text-3xl font-bold text-white lg:text-black mb-4 drop-shadow-lg">Kabupaten Layak Anak
                        </h2>
                        <p class="text-white/90 lg:text-black/90 mb-6 drop-shadow-md max-w-xs">Mewujudkan Katingan yang
                            ramah dan layak bagi tumbuh kembang anak</p>
                    </div>
                </div>

                <!-- Dynamic Slider -->
                <div class="w-full lg:flex-1 h-[400px] lg:h-[500px] relative overflow-hidden" x-data="{ 
                        currentIndex: 0,
                    ...
                    }" x-init="init()" @mouseenter="stopTimer()" @mouseleave="if (canSlide) startTimer()">
                        ...
                        <div class="absolute inset-0 w-full h-full transition-all duration-1000"
                            ...
                            <div class="absolute bottom-0 left-0 right-0 p-6 lg:p-12 text-center">
                                ...
                                @if($slide->description)
                                    <p
                                        class="text-white/90 text-sm lg:text-xl max-w-3xl mx-auto lg:leading-relaxed drop-shadow-md slide-up-delayed">
                                        {{ $slide->description }}
                                    </p>
                                @endif
                            </div>
    ...
    <section id="klaster-section" class="relative py-16 bg-gradient-to-br from-blue-200 via-white to-purple-100">
        <div class="absolute inset-0 bg-gradient-to-br from-blue-200/80 via-white/60 to-purple-100/80 backdrop-blur-sm">
        </div>
                        ...
                        <div class="klaster-slider">
                            <div class="klaster-slide">
                                <a href="{{ route('pemenuhan-hak-anak.klaster1') }}">
                                    <div
                                        class="relative overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full bg-gradient-to-br from-orange-200 via-orange-100 to-orange-300 rounded-lg">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="klaster-description h-12 flex items-center justify-center">Hak
                                                Sipil dan Kebebasan</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="klaster-slide">
                                <a href="{{ route('pemenuhan-hak-anak.klaster2') }}">
                                    <div
                                        class="relative overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full bg-gradient-to-br from-yellow-200 via-yellow-100 to-yellow-300 rounded-lg">
                                        <div class="aspect-w-16 aspect-h-9">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="klaster-description h-12 flex items-center justify-center">
                                                Lingkungan Keluarga dan Pengasuhan Alternatif</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="klaster-slide">
                                <a href="{{ route('pemenuhan-hak-anak.klaster3') }}">
                                    <div
                                        class="relative overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full bg-gradient-to-br from-green-200 via-green-100 to-green-300 rounded-lg">
                                        <div class="aspect-w-16 aspect-h-9">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="klaster-description h-12 flex items-center justify-center">
                                                Kesehatan Dasar dan Kesejahteraan</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="klaster-slide">
                                <a href="{{ route('pemenuhan-hak-anak.klaster4') }}">
                                    <div
                                        class="relative overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full bg-gradient-to-br from-sky-200 via-sky-100 to-sky-300 rounded-lg">
                                        <div class="aspect-w-16 aspect-h-9">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="klaster-description h-12 flex items-center justify-center">
                                                Pendidikan, Pemanfaatan Waktu Luang, dan Kegiatan Budaya</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="klaster-slide">
                                <a href="{{ route('perlindungan-khusus-anak.klaster5') }}">
                                    <div
                                        class="relative overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full bg-gradient-to-br from-red-200 via-red-100 to-red-300 rounded-lg">
                                        <div class="aspect-w-16 aspect-h-9">
        ...
        <div class="absolute bottom-0 left-0 right-0 w-full h-16 overflow-hidden z-20">
            <svg class="absolute bottom-0 w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
                preserveAspectRatio="none">
                <path fill="rgb(224 231 255)"
    ...
    <section id="berita-agenda-section" class="relative py-16 bg-gradient-to-br from-indigo-100 via-white to-blue-100">
        <div class="absolute inset-0 bg-gradient-to-br from-indigo-100/80 via-white/60 to-blue-100/80 backdrop-blur-sm">
        </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-col lg:flex-row lg:justify-between gap-4 mt-8">
                    <div class="w-full lg:w-2/3">
                        <div
                            class="bg-gradient-to-br from-blue-50 to-indigo-50 overflow-hidden shadow-lg sm:rounded-lg mt-8">
                            <div class="p-6">
                                ...
                                <div class="flex flex-col divide-y-4 divide-dashed divide-indigo-200 space-y-6">
                                    @forelse($latestNews as $item)
                                        <div
                                            class="flex flex-col md:flex-row gap-4 bg-gradient-to-r from-white via-blue-50 to-indigo-50 p-4 rounded-xl hover:shadow-lg transition-all duration-300 hover:from-blue-50 hover:via-indigo-50 hover:to-white {{ !$loop->first ? 'pt-10' : '' }}">
                                            <div class="w-full md:w-1/3 relative overflow-hidden rounded-lg">
                                                @if($item->image)
                                                    <div class="relative group">
                                                        ...
                                                        <div
                                                            class="absolute inset-0 bg-gradient-to-t from-indigo-900/30 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                        </div>
                                                    </div>
                                                @else
                                                    <div
                                                        class="w-full h-48 bg-gradient-to-br from-blue-200 to-indigo-200 rounded-lg">
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="w-full md:w-2/3">
                                                <h3 class="text-xl font-semibold text-indigo-700 hover:text-indigo-900">
                                                    <a
                                                        href="{{ route('berita.detail', ['title' => Str::slug($item->title)]) }}">
                                                        {{ $item->title }}
                                                    </a>
                                                </h3>
                                    ...
                                    @empty
                                        <div class="text-center py-12 bg-white/60 rounded-xl">
                                            <div class="mb-4">
                                                <svg class="mx-auto h-16 w-16 text-indigo-300" fill="none"
                        ...
                        <div class="bg-gradient-to-br from-emerald-50 to-teal-100 p-6 shadow-lg rounded-lg mt-8">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                @forelse($upcomingAgendas as $item)
                                    <div
                                        class="flex gap-4 p-4 bg-white/80 rounded-xl hover:shadow-lg transition-all duration-300">
                                        <div class="w-20 flex-shrink-0">
                                            <div
                                                class="bg-gradient-to-br from-emerald-100 to-teal-200 rounded-lg p-3 text-center shadow-md">
        ...
        <div class="absolute bottom-0 left-0 right-0 w-full h-16 overflow-hidden">
            <svg class="absolute bottom-0 w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
                preserveAspectRatio="none">
                <path fill="rgb(243 232 255)"
                    d="M0,288L60,261.3C120,235,240,181,360,181.3C480,181,600,235,720,245.3C840,256,960,224,1080,213.3C1200,203,1320,213,1380,218.7L1440,224L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z">
                </path>
            </svg>
        </div>
    </section>
    ...
    <section id="galeri-video-dokumen-section"
        class="relative py-16 bg-gradient-to-br from-purple-100 via-white to-pink-100">
        <div class="absolute inset-0 bg-gradient-to-br from-purple-100/80 via-white/60 to-pink-100/80 backdrop-blur-sm">
        </div>
